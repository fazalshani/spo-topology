...
class natlas:
    ...
    def snmp_add_credential(self, snmp_ver, snmp_community):
        print('natlas ==> snmp_add_credential()')
        if (self.config == None):
