...
class natlas_diagram_dot_node:
    def __init__(self):
        print('natlas_diagram_dot_node ==> __init__()')
        self.ntype = 'single'
        self.shape = 'ellipse'
        self.style = 'solid'
        self.peripheries = 1
...
class natlas_output_diagram:
    ...
    def __init__(self, network):
        print('natlas_output_diagram ==> __init__()')
        natlas_output.__init__(self)
        self.network = network
        self.config  = network.config

    def generate(self, dot_file, title):
        print('natlas_output_diagram ==> generate()')
    ...
    def __generate(self, diagram, node):
        print('natlas_output_diagram ==> __generate()')
        if (node == None):
            return (0, 0)
    ...
    def __get_node(self, diagram, node):
        print('natlas_output_diagram ==> __get_node()')
    ...
    def __create_link(self, diagram, node, link, draw_as_lag):
        print('natlas_output_diagram ==> __create_link()')
        link_color = 'black'
        link_style = 'solid'
        link_label = ''
    ...
    def __does_lag_span_devs(self, lag_name, links):
        print('natlas_output_diagram ==> __does_lag_span_devs()')
        if (lag_name == None):
            return 0
    ...
    def __eval_if_block(self, if_cond, node):
        print('natlas_output_diagram ==> __eval_if_block()')
        # evaluate condition
    ...
    def __get_node_text(self, diagram, node, fmt):
        print('natlas_output_diagram ==> __get_node_text()')
        '''
