...
class natlas_network:
    ...
    def set_verbose(self, level):
        print('natlas_network ==> set_verbose()')
        '''
    ...
    def discover_details(self):
        print('natlas_network ==> discover_details()')
        '''
    ...
    def __print_step(self, ip, name, depth, dcodes):
        print('natlas_network ==> __print_step()')
        if (self.verbose == 0):
            return
    ...
    def __query_node(self, ip, host):
        print('natlas_network ==> __query_node()')
        '''
        Query this node.
    ...
    def __get_known_node(self, ip, host):
        print('natlas_network ==> __get_known_node()')
        '''
    ...
    def __discover_node(self, node, depth):
        print('natlas_network ==> __discover_node()')
        '''
    ...
    def __match_node_acl(self, ip, host, platform=None, software=None, serial=None):
        print('natlas_network ==> __match_node_acl()')
    ...
    def __match_ip(self, ip, cidr):
        print('natlas_network ==> __match_ip()')
        if (cidr == 'any'):
            return 1
    ...
    def __match_strpattern(self, str, pattern):
        print('natlas_network ==> __match_strpattern()')
        if (str == '*'):
            return 1
    ...
    def __add_link(self, node, link):
        print('natlas_network ==> __add_link()')
    ...
    def __get_known_node_by_host(self, hostname):
        print('natlas_network ==> __get_known_node_by_host()')
        '''
