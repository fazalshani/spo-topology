...
class natlas_node_link:
    ...
    def __init__(self):
        print('natlas_node_link ==> __init__()')
        # the linked node
        self.node                       = None
...
class natlas_node:
    ...
    def add_link(self, link):
        print('natlas_node_link ==> add_link()')
    ...
    def try_snmp_creds(self, snmp_creds):
        print('natlas_node_link ==> try_snmp_creds()')
    ...
    def query_node(self):
        print('natlas_node_link ==> query_node()')
    ...
    def __get_cidrs_from_ifidx(self, ifidx):
        print('natlas_node_link ==> __get_cidrs_from_ifidx()')
        ips = []
    ...
    def __cache_common_mibs(self):
        print('natlas_node_link ==> __cache_common_mibs()')
    ...
    def get_cdp_neighbors(self):
        print('natlas_node_link ==> get_cdp_neighbors()')
        neighbors = []
        snmpobj = self.snmpobj
    ...
    def get_lldp_neighbors(self):
        print('natlas_node_link ==> get_lldp_neighbors()')
        neighbors = []
        snmpobj = self.snmpobj
    ...
    def __get_node_link_info(self, ifidx, ifidx2):
        print('natlas_node_link ==> __get_node_link_info()')
        snmpobj = self.snmpobj
    ...
    def __parse_allowed_vlans(self, allowed_vlans):
        print('natlas_node_link ==> __parse_allowed_vlans()')
    ...
    def __get_chassis_info(self):
        print('natlas_node_link ==> __get_chassis_info()')
        # Get:
        #    Serial number
        #    Platform
        #    IOS
    ...
    def __get_ifname(self, ifidx):
        print('natlas_node_link ==> __get_ifname()')
    ...
    def get_system_name(self, domains):
        print('natlas_node_link ==> get_system_name()')
    ...
    def __format_ios_ver(self, img):
        print('natlas_node_link ==> __format_ios_ver()')
        x = img
        if (type(img) == bytes):
            x = img.decode("utf-8")
    ...
    def get_ipaddr(self):
        print('natlas_node_link ==> get_ipaddr()')
        '''
    ...
    def __get_vpc_info(self, ifarr):
        print('natlas_node_link ==> __get_vpc_info()')
        '''
        If VPC is enabled,
    ...
    def get_vlans(self):
        print('natlas_node_link ==> get_vlans()')
    ...
    def get_arp_table(self):
        print('natlas_node_link ==> get_arp_table()')
        # use cache if possible
    ...
    def shorten_port_name(self, port):
        print('natlas_node_link ==> shorten_port_name()')
        if (port == OID_ERR):
            return 'UNKNOWN'
