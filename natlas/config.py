...
class natlas_discover_acl:
    ...
    def __init__(self, str):
        print('natlas_discover_acl ==> __init__()')
        self.action     = "nop"
        self.type       = "nop"
        self.str        = "nop"
...
class natlas_config:
    ...
    def __load_json_conf(self, json_file):
        print('natlas_config ==> __load_json_conf()')
        json_data = None
        fd = open(json_file)
        json_data = fd.read()
        fd.close()
    ...
    def generate_new(self):
        print('natlas_config ==> generate_new()')
        return '{\n' \
                        '       "snmp" : [\n' \
    ...
    def validate_config(self, filename):
        print('natlas_config ==> validate_config()')
    ...
    def __validate_config_snmp(self, data):
        print('natlas_config ==> __validate_config_snmp()')
    ...
    def __validate_config_domains(self, data):
        print('natlas_config ==> __validate_config_domains()')
    ...
    def __validate_config_discover(self, data):
        print('natlas_config ==> __validate_config_discover()')
    ...
    def __validate_config_diagram(self, data):
        print('natlas_config ==> __validate_config_diagram()')
